...
void add(unordered_map<int,unordered_map<int,int>>& z,int x1, int y1, int a, int b)
{
    z[x1+a][y1+b]=1;
    z[x1+a][y1-b]=1;
    z[x1-a][y1+b]=1;
...
void find(unordered_map<int,unordered_map<int,int>>& z,int x1, int y1, int a, int b)
{
    int s=0;
    if(z[x1+a][y1+b]) z[x1+a][y1+b]=0,s++;
    if(z[x1+a][y1-b]) z[x1+a][y1-b]=0,s++;
    if(z[x1-a][y1+b]) z[x1-a][y1+b]=0,s++;
    if(z[x1-a][y1-b]) z[x1-a][y1-b]=0,s++;
    if(z[x1+b][y1+a]) z[x1+b][y1+a]=0,s++;
    if(z[x1+b][y1-a]) z[x1+b][y1-a]=0,s++;
    if(z[x1-b][y1+a]) z[x1-b][y1+a]=0,s++;
    if(z[x1-b][y1-a]) z[x1-b][y1-a]=0,s++;
    cout<<s<<'\n';
